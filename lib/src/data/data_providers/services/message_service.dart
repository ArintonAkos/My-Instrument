...
class MessageService extends HttpService {
  MessageService({ required AppLanguage appLanguage}) : super(appLanguage: appLanguage);
  ...
  Future<my_base_response.BaseResponse> getMessageList() async {
    if (await model.ensureAuthorized()) {
      ...
      if (res.statusCode == 200) {
        ...
        MessageResponse messageResponse = MessageResponse(body, appLanguage);
  ...
  Future<my_base_response.BaseResponse> getMessages(String userId, int page) async {
    if (await model.ensureAuthorized()) {
      ...
      if (res.statusCode == 200) {
        ...
        ChatMessageResponse chatMessageResponse = ChatMessageResponse(body, appLanguage);
  ...
  Future<my_base_response.BaseResponse> getUnseenMessageMembers() async {
    if (await model.ensureAuthorized()) {
      ...
      if (res.statusCode == 200) {
        ...
        UnseenMessageMemberResponse response = UnseenMessageMemberResponse(body, appLanguage);
        return response;
      }
    }
  ...
  Future<my_base_response.BaseResponse> sendMessage(SendMessageRequest data) async {
    if (await model.ensureAuthorized()) {
      ...
      if (res.statusCode == 200) {
        ...
        my_base_response.BaseResponse sendMessageResponse = my_base_response.BaseResponse(body, appLanguage);
