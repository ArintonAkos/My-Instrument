        ...
        children: [
          Expanded(
            child: Stepper(
              ...
              steps: <Step>[
                Step(
                  title: const Text('The Title and the Price of your instrument'),
                  content: Column(
                    children: <Widget>[
                      Form(
                ...
                Step(
                  title: const Text('The Description of your instrument'),
                  content: Form(
                    key: _descriptionKey,
                    child: Column(
                      children: <Widget>[
                ...
                Step(
                  title: const Text('What kind of instrument are you selling?'),
                  content: Column(
                    children: <Widget>[
                      FormField<String>(
